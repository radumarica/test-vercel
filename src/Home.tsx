    ...
    return (
      ...
      {/* ............ testing */}
                <MintContainer>
                    ...
                    <DesContainer>
                        <Des elevation={2}>
                            <LogoAligner><img src="palmverselogo.png" alt=""></img><GoldTitle>Welcome to Palmverse DAO!</GoldTitle></LogoAligner>
                            <p>PALMVERSE is the first NFT tied to physical hospitality business, utilizing the power of the Solana blockchain.</p>

                            <p>Hotel & Hostel Chain -with all the amenities for digital nomads, co-working spaces, gym, shared kitchen, bars, pool. 
                                It will be open to everyone.</p>
                                
                            <p>Gather with the NFT community IRL, either if you come for a holiday or for a longer period while working remotely.</p>
                        </Des>
                        <Des elevation={2}>
                            <LogoAligner><img src="palmverselogo.png" alt=""></img><GoldTitle>TOKEN STAKING</GoldTitle></LogoAligner>                    
                            <p>Premium beach locations, easy access to water sports like surfing, canoeing.</p>

                        </Des>
                        <Des elevation={2}>
                            <LogoAligner><img src="palmverselogo.png" alt=""></img><GoldTitle>Minting Information</GoldTitle></LogoAligner>
